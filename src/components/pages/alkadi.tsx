        ...
        <div className="text-center space-y-8">
          <div className="max-w-screen-md mx-auto text-center text-4xl md:text-6xl font-bold">
            <h1>
              Booking GOR di
              <span className="px-2">
                <span className="text-transparent bg-gradient-to-r from-[#00008B] to-[#00008B] bg-clip-text">
                  Al
                </span>
                <span className="text-transparent bg-gradient-to-r from-red-600 to-red-600 bg-clip-text">
                  kadi
                </span>
              </span>
              lebih mudah
