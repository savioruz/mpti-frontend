...
import { useRegister, initiateGoogleLogin, saveAuthTokens, type UserRegisterRequest } from "@/lib/auth.ts";
...
export function RegisterForm({
    ...
    const [registerData, setRegisterData] = useState<UserRegisterRequest & { confirmPassword: string }>({
        name: "",
        email: "",
        password: "",
        confirmPassword: "",
                ...
                <span className="bg-card text-muted-foreground relative z-10 px-2">
                  Or continue with
                            ...
                            <div className="text-center text-sm">
                                ...
                                <Link to={publicLinks.login.to} className="underline underline-offset-4">
                                    Login
                                </Link>
                            </div>
                        </div>
