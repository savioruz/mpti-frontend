import {
  ...
  const FAQList: FAQProps[] = [
    ...
    {
      question:
        "Apakah bisa memesan untuk hari ini juga (booking mendadak)?",
      answer:
        "Ya, selama slot masih tersedia ",
      value: "item-3",
    },
    {
    ...
    {
      question:
        "Apakah tersedia fasilitas parkir dan ruang tunggu?",
  ...
  export const FAQSection = () => {
    return (
      <section id="faq" className="w-full px-4 py-24 sm:py-32 flex justify-center">
